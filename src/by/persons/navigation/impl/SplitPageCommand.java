...
public class SplitPageCommand implements Command {

    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        HttpSession session = request.getSession();
        QueryManager queryManager = new QueryManager(PARAM_SORT, QUERY_LIMIT_VALUE);
        queryManager.obtainSortModeFromSession(session);
        ...
        pageSplitter.obtainQuantityLinesPerPageFromRequest(request);
